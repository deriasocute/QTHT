    ...
    return {
        ...
        scrollInit: function(element, options) {
            ...
            function init() {
                var ps;
                var height;
                if (KTUtil.attr(element, 'data-max-height')) {
                    KTUtil.css(element, 'max-height', KTUtil.attr(element, 'data-max-height') + 'px');
                }
                ...
                if (attrs.length > 0) {
                    attrs.forEach(function(attrName) {
                        ...
                        if ((/^data-.*/g).test(attrName)) {
                            if (['scroll', 'height', 'max-height', 'mobile-height'].includes(optionName) == false) {
                ...
                //use icon scroll more
                if (options.scrollIcon == true) {
                    if ($(element).next('.scroll-more-module').length == 0) {
                        $("<div class='scroll-more-module active mt-2'><i class='fal fa-angle-down'></i></div>").insertAfter(element);
                    }
                }
                ...
                if (KTUtil.attr(element, 'data-suppress-scroll-x')) {
                    options.suppressScrollX = KTUtil.attr(element, 'data-suppress-scroll-x');
                }
                ...
                if (KTUtil.attr(element, 'data-scroll-icon') == 'true') {
                    options.scrollIcon = true;
                }
                ...
                if (options.scrollIcon == true) {
                    element.addEventListener('ps-scroll-y', function() {
                        var obj = $(element);
                        if (ps.reach.y == 'end') {
                            obj.next('.scroll-more-module').removeClass('active');
                        } else {
                            obj.next('.scroll-more-module').addClass('active');
                        }
                    });
                }
        ...
        scrollUpdate: function(element) {
            ...
            if (KTUtil.attr(element, 'data-remember-position') != 'true') {
                $(element).next('.scroll-more-module').addClass('active');
            }
            if (ps) {
                ps.update();
            }
    ...
    $.fn[pluginName].defaults = {
        ...
        layout: {
            ...
            icons: {
                ...
                pagination: {
                    next: 'ce-icon-ki-arrow-next',
                    prev: 'ce-icon-ki-arrow-back',
                    first: 'ce-icon-ki-double-arrow-back',
                    last: 'ce-icon-ki-double-arrow-next',
                    more: 'ce-icon-ki-bold-more-hor'
                },
                rowDetail: {
...
var KTLayoutChat = function() {
    ...
    var _handeMessaging = function(element) {
        ...
        html += '		<img alt="Pic" src="/Assets/app/media/users/300_12.jpg"/>';
        html += '	</div>';
        html += '</div>';
