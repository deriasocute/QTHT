...
var KTDatatableChildRemoteDataDemo = function() {
    ...
    var demo = function() {
        ...
        var datatable = $('#kt_subdatatable').KTDatatable({
            ...
            search: {
                input: $('#kt_subdatatable_search_query'),
                key: 'generalSearch'
            },
	                                ...
	                                <ul class="navi flex-column navi-hover py-2">\
	                                    ...
	                                    <li class="navi-item">\
	                                        <a href="#" class="navi-link">\
	                                            <span class="navi-icon"><i class="fal fa-print"></i></span>\
	                                            <span class="navi-text">Print</span>\
	                                        </a>\
	                                    </li>\
	                                    <li class="navi-item">\
	                                        <a href="#" class="navi-link">\
	                                            <span class="navi-icon"><i class="fal fa-copy"></i></span>\
	                                    ...
	                                    <li class="navi-item">\
	                                        <a href="#" class="navi-link">\
	                                            <span class="navi-icon"><i class="far fa-file-alt"></i></span>\
        ...
        $('#kt_subdatatable_search_status').on('change', function() {
            datatable.search($(this).val().toLowerCase(), 'Status');
        });

        $('#kt_subdatatable_search_type').on('change', function() {
            datatable.search($(this).val().toLowerCase(), 'Type');
        });

        $('#kt_subdatatable_search_status, #kt_subdatatable_search_type').selectpicker();
...
jQuery(document).ready(function() {
    if (jQuery('#kt_subdatatable').length != 0) {
